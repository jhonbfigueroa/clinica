<div class="login-box">
  <div class="login-logo">
    <a href="http://localhost/clinica/seleccionar"><b>Clínica Médica</b></a>
  </div>
  <!-- /.login-logo -->
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <a href="http://localhost/clinica/seleccionar" class="btn btn-warning btn-block btn-flat">Regresar</a>
        </div>
